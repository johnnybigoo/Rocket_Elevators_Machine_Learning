...
User.create(id: 1,email: 'nicolas.genest@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 2,email: 'nadya.fortier@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 3,email: 'martin.chantal@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 4,email: 'mathieu.houde@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 5,email: 'patrick.thibault@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 6,email: 'david.boutin@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 7,email: 'mathieu.lortie@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 8,email: 'thomas.carrier@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 9,email: 'serge.savoie@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 10,email: 'francis.patry-jessop@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 11,email: 'mathieu.lefrancois@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 12,email: 'david.larochelle@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 13,email: 'nicolas.pineault@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 14,email: 'david.amyot@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 15,email: 'remi.gagnon@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 16,email: 'timothy.wever@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 17,email: 'kiril.kleinerman@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 18,email: 'emmanuela.derilus@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 19,email: 'abdul.akeeb@codebozz.biz',password: 'password',date_created: '20120618')
User.create(id: 20,email: 'krista.sheely@codeboxx.biz',password: 'password',date_created: '20120618')
User.create(id: 21,email: 'jonathan.murray@codeboxx.biz',password: 'password',date_created: '20120618')
